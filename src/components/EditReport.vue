<template>
    <main>
        ...
        <div class="row m-5">
            <h2 class="text-white col-xl-11 ">Edit Report</h2>
            <button @click="editReport('New')" id="deploy" class=" col-xl-1" >Edit Report</button>
        </div>
        <div class="row m-0">
            <div class="col-xl-6 mx-0 ">
                <div class="card m-2">
                    ...
                    <div class="form-group mt-3 mb-0" v-if="my_report.vuln.name">
                    ...
                    <div class="form-group my-3 ">
                        <label class="pb-2"> Severity Level : {{my_report.severity}}</label>
            ...
            <div class="col-xl-6 mx-0 ">
                <div class="card m-2">
                    ...
                    <button  class="btn btn-secondary w-25"  @click="target('saved')">Save</button>
    ...
    export default {
        ...
        methods: {
            ...
            editReport(status) {
                ...
                if(this.my_report.vuln_name) formData.append('vuln_name', this.my_report.vuln_name);
                if(status == 'saved') formData.append('status', status);
                if(this.my_report.target) formData.append('target', this.my_report.target);
                if(this.my_report.severity) formData.append('severity', this.my_report.severity);
                if(this.my_report.vuln_details) formData.append('vuln_details', this.my_report.vuln_details);
                if(this.my_report.validation_steps) formData.append('validation_steps', this.my_report.validation_steps);
