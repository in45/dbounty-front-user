<template>
	<div class="vue-image-crop-upload row m-0" v-show="modelValue">
		<div class="vicp-wrap col-xl-5 col-sm-7">
			<div class="vicp-close" @click="$emit('close')">
				<i class="vicp-icon4"></i>
			</div>

			<div class="vicp-step1 row m-0" v-show="step == 1">
				<div class="vicp-drop-area col-xl-10" @dragleave="preventDefault" @dragover="preventDefault" @dragenter="preventDefault" @click="handleClick" @drop="handleChange">
				...
				<div class="vicp-operate">
					<a @click="$emit('close')" @mousedown="ripple">{{ lang.btn.off }}</a>
				</div>
			</div>
			...
			<div class="vicp-step3" v-if="step == 3">
				...
				<div class="vicp-operate">
					...
					<a @click="$emit('close')" @mousedown="ripple">{{ lang.btn.close }}</a>
				</div>
			</div>
